...
<customize-form params="
    ...
    <div class="form-vertical" data-bind="foreach: $component.fields">
      <div class="form-row">
        <label data-bind="text: label + ':'">ID:</label>
        <input data-bind="
               attr: { type: type },
               value: $component.currentObject()[name],
               enable: editable,
               valueUpdate: 'input'" type="text" disabled="">
      ...
      <div class="form-row">
        <label data-bind="text: label + ':'">Created At:</label>
        <input data-bind="
               attr: { type: type },
               value: $component.currentObject()[name],
               enable: editable,
      ...
      <div class="form-row">
        <label data-bind="text: label + ':'">Updated At:</label>
        <input data-bind="
               attr: { type: type },
               value: $component.currentObject()[name],
               enable: editable,
