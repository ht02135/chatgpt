...
public class Step1CreateBatchHeader extends StepExecutionListenerSupport implements Tasklet {
    ...
    // Default file paths / filenames
    public static final String DEFAULT_ORIGINAL_FILENAME = "generated_user_lists.csv";
    public static final String DEFAULT_FILE_PATH = "/data/user_lists/generated_user_lists.csv";
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
        ...
        userList.setUserListName(DEFAULT_USER_LIST_NAME);
        userList.setOriginalFileName(DEFAULT_ORIGINAL_FILENAME);
        userList.setFilePath(DEFAULT_FILE_PATH);
        userList.setDescription(DEFAULT_DESCRIPTION);
