...
public class SummarizationServiceImpl implements SummarizationService {
    ...
    /*
     * hung: fallback default constructor for standalone testing
     */
    public SummarizationServiceImpl() {
        logger.debug("SummarizationServiceImpl default constructor called");
        this.client = OpenAIOkHttpClient.fromEnv();
        logger.debug("SummarizationServiceImpl default client initialized via fromEnv()");
    }
