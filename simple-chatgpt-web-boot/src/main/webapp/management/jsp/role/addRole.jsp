...
<body>
    ...
    <script type="module">
        ...
        (async function () {
            console.log('Initializing Add Role page...');

            // ✅ Load form config for Roles
            const formConfig = await configLoader.getFormConfig("addRole");
            ...
            // ✅ Initialize current Role as empty
            roleVM.currentObject(new Role({}, formConfig.fields));
