...
public class PropertyManagementValidator implements ConstraintValidator<ValidManagementProperty, PropertyManagementPojo> {
	private static final Logger logger = LogManager.getLogger(PropertyManagementValidator.class);
	
    @Override
    public void initialize(ValidManagementProperty constraintAnnotation) {
        // No initialization needed
    }

    @Override
    public boolean isValid(PropertyManagementPojo property, ConstraintValidatorContext context) {
