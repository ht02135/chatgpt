...
<div class="container" data-bind="with: userVM">
    ...
    <form class="form-vertical" data-bind="submit: saveUser">
        <fieldset>
            ...
            <div class="form-row"><label>First Name:</label><input type="text" data-bind="value: currentUser().firstName" required></div>
            <div class="form-row"><label>Last Name:</label><input type="text" data-bind="value: currentUser().lastName" required></div>
